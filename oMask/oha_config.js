...
oha_config.subtitle[oha_api.langCode.English]="Smart face massager";
// TraditionalChinese
oha_config.title[oha_api.langCode.TraditionChinese]="oMask(V"+oha_config.sw_ver.toFixed(3)+")";
oha_config.subtitle[oha_api.langCode.TraditionChinese]="Smart face massager";
// SimleChinese
oha_config.title[oha_api.langCode.SimpleChinese]="oMask(V"+oha_config.sw_ver.toFixed(3)+")";
oha_config.subtitle[oha_api.langCode.SimpleChinese]="Smart face massager";
// Korea
oha_config.title[oha_api.langCode.Korean]="oMask(V"+oha_config.sw_ver.toFixed(3)+")";
oha_config.subtitle[oha_api.langCode.Korean]="Smart face massager";

oha_config.title[oha_api.isoCountries.Japan]="oMask(V"+oha_config.sw_ver.toFixed(3)+")";
oha_config.subtitle[oha_api.isoCountries.Japan]="Smart face massager";
// =========================================================================
