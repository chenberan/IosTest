...
V1.250
1. Support oMass+PhoneBull
V1.260
1. 切換oMass/PhoneBull支援在裝置啟動前都可以顯示。
V1.270
1. 修正雙頁面合一下的Lock/DevReady不一致的問題。
V1.280
1. 穴道圖改為UHO版本
2. 調整圖大小, 減少網頁大小
V1.290
1. 將oMass/PhoneBull合而為一, 同時下載
V1.300
1. 修改啟動時會先有較大輸出。
V1.310
1. 增加滑動區的按壓事件發生時, 回傳JS function給App
V1.330_Debug
1. Debug Cookie的問題
V1.350
1. 為了支援連結外部網頁問題, 因此, 內部連結, 需加上參數?Local=true;
2. 修改判斷DevReady的參數傳遞, 符合URL的標準格式 OHA_DevId=0 
V1.360
1. 改善PhoneBull的圖形Size
v1.620
1. 將背景及圖示改為SVG
